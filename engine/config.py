...
POST_EXIT_WATCH_HOURS = float(os.environ.get("POST_EXIT_WATCH_HOURS", "24"))
...
# 0 = limitsiz (24s izleme dogal olarak kisalir; analiz logu kalite olcumu icin tutulur)
...
SCAN_MODE = os.environ.get("SCAN_MODE", "priority")  # priority | best_signal
SYMBOL_LOCK_MODE = os.environ.get("SYMBOL_LOCK_MODE", "global")  # global | per_ledger | none
SIGNAL_LOG_RESET_HOUR = int(os.environ.get("SIGNAL_LOG_RESET_HOUR", "3"))  # TR, gunluk 1d mum baslangici
