...
from ui_common import patlama_rows, setup_page, source_caption

data = setup_page("Patlama / Selale Tarama", icon="🚀")
...
if df.empty:
    st.warning(
        "Henuz tarama verisi yok. Render motoru yeni surumu calistirdiktan sonra "
...
st.info(
    "Sol menuden otomatik yenilemeyi kapatabilirsin. Kapali iken tablo sabit kalir; "
    "incelemeyi bitirince **Simdi yenile** ile guncellersin."
)
